...
func TestLower_DateLength_TooShort(t *testing.T) {
	...
	d := lowerAndFindDiagnostic(t, src, types.StrictConfig(), types.DiagDateLength)
...
func TestLower_DateCharacter_NonDigit(t *testing.T) {
	...
	d := lowerAndFindDiagnostic(t, src, types.StrictConfig(), types.DiagDateCharacter)
...
func TestLower_DateMonth_Zero(t *testing.T) {
	...
	d := lowerAndFindDiagnostic(t, src, types.StrictConfig(), types.DiagDateMonth)
...
func TestLower_DateDay_Zero(t *testing.T) {
	...
	d := lowerAndFindDiagnostic(t, src, types.StrictConfig(), types.DiagDateDay)
...
func TestLower_DateHour_TwentyFour(t *testing.T) {
	...
	d := lowerAndFindDiagnostic(t, src, types.StrictConfig(), types.DiagDateHour)
...
func TestLower_DateMinutes_Sixty(t *testing.T) {
	...
	d := lowerAndFindDiagnostic(t, src, types.StrictConfig(), types.DiagDateMinutes)
...
func TestLower_DateValue_Feb30(t *testing.T) {
	...
	d := lowerAndFindDiagnostic(t, src, types.StrictConfig(), types.DiagDateValue)
...
func TestLower_DateYear2Digits(t *testing.T) {
	...
	d := lowerAndFindDiagnostic(t, src, types.StrictConfig(), types.DiagDateYear2Digits)
...
func TestLower_DateInPast(t *testing.T) {
	...
	d := lowerAndFindDiagnostic(t, src, types.StrictConfig(), types.DiagDateInPast)
...
func TestLower_DateInFuture(t *testing.T) {
	...
	d := lowerAndFindDiagnostic(t, src, types.StrictConfig(), types.DiagDateInFuture)
...
func TestLower_DateValid_NoDiagnostic(t *testing.T) {
	...
	for _, code := range codes {
		d := lowerAndFindDiagnostic(t, src, types.StrictConfig(), code)
...
`)
	d := lowerAndFindDiagnostic(t, src, types.StrictConfig(), types.DiagRevisionNotDescending)
...
`)
	d := lowerAndFindDiagnostic(t, src, types.StrictConfig(), types.DiagRevisionAfterUpdate)
